...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $results = $database->execute_query("SELECT * FROM contatos WHERE nome LIKE  :search OR telefone LIKE :search ORDER BY id DESC", $params);
} else {
                ...
                <tbody>
                    <?php foreach($contacts as $contact):?>
                        <tr>
                            ...
                            <td class="text-center"><a href="eliminar_contacto.php?id=<?= $contact->id?>">Excluir</a></td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
            </table>
